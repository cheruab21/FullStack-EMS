...
const LoginLeftside = () => {
  return (
    <div className="hidden md:flex w-1/2 bg-indigo-950 h-screen relative overflow-hidden border-r border-slate-200">
...
s
        <div className=" relative z-10 flex flex-col items-start justify-center p-12 lg:p-20 w-full h-full ">
            ...
            <p className="text-slate-400 text-lg max-w-md leading-relaxed">Streamline your workforce management, track attendance, and manage leaves with our intuitive platform.</p>
        </div>
